        ...
        <div class="card-body">
            ...
            <table data-provide="datatables" class="table table-responsive table-sm">
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td><small>RP - 10 /M.5.13/Euh/01/2021</small></td>
...
<div class="modal modal-center fade" id="modal-add" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="border-radius: 10px;">
            <form action="<?php echo base_url(); ?>admin/RP10/add" method="POST">
...
<div class="modal modal-center fade" id="modal-edit" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="border-radius: 10px;">
            <form action="<?php echo base_url(); ?>admin/RP10/update" method="POST">
                <div class="modal-header">
...
<div class="modal modal-center fade" id="modal-delete" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 10px;">
            <form action="<?php echo base_url(); ?>admin/RP10/delete" method="POST">
                <div class="modal-header">
...
<script>
    function getview(id) {
        $.getJSON("<?php echo base_url(); ?>admin/RP10/view/" + id, function(data) {
            // console.log(data);
